...
// express.static  = function(req,resp, callback){ //look for  static/img/corgi.png  return it in response}
// can I use Reg Expression here? todo 
...
//response.download(file.ext)   motiv
